...
def GOAP_script(req):
    ...
    if req.emergency == False and counter_scripts == 0: #blue team script
        ...
        # script for demo 0731
        scrpit_mission =[39,14,32,38,13,
        ...
        position_script=[
          # [req.my_pos[0],req.my_pos[1],req.my_pos[2]],
            [973.036, 2749.5813,2.580415466],#before mission 14 
             [1583.036 ,2354.475144, 2.58],#mission 14
             [1583.036 ,2354.475144, 2.68],#wait

             [596.872, 2759.329, -2.403962],[350.9697626, 2505.356, -2.303962],
            current.cup_state[20]['robot_pos'],  current.cup_state[19]['robot_pos'],
            # [279.693, 2232.334,2.6199707],
            ...
            [1471.41550269, 1210.9632466,0.01], #放杯前的點
             [1738.03586831, 1207.28766048,0.0], #pla0ce 4cup 12
             [1688.03586831, 1207.28766048,0.0], #pla0ce 2cup
             [1538.03586831, 1207.28766048,0.0], #back off
             [1538.03586831, 1207.28766048,(math.pi-0.1)], #turn around
             [1598.03586831, 1207.28766048,math.pi], #pla0ce 4cup 16
             [1568.03586831, 1207.28766048,math.pi], #pla0ce 2cup
             [1378.03586831, 1207.28766048,math.pi], #back off
            #  [1378.03586831, 1207.28766048,math.pi], #wait
            [800, 1650, 2.2756502662], #go home yeah~

            [331.684992696, 2455.45267953, 2.2756502662], #go home yeah~
